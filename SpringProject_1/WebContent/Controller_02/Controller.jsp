...
<body>
	<fieldset>
		...
		<ul style="list-style-type: upper-roman;">
			<li>
				<a href="<c:url value='/Controller/MoveByMe.do?paramvar=MoveByMe!!!'/>">
					페이지 이동 첫번째]내가 만든 컨트롤러로 이동
				</a>
			</li>
			<li>
				<a href="<c:url value='/Controller/MoveBySpring.do?paramvar=MoveBySpring!!!'/>">
					페이지 이동 두번째]스프링에서 제공하는 컨트롤러로 이동
				</a>
			</li>
			<li>
				<a href="<c:url value='/Controller/ControllerInterface.do?paramvar=[Controller Interface]'/>">
					Controller 인터페이스로 컨트롤러 만들기
				</a>
			</li>
			<li>
				<a href="<c:url value='/Controller/AbstractController.do?paramvar=[AbstractController class]'/>">
					AbstractController 클래스로 컨트롤러 만들기
				</a>
			</li>
			<li>
				<a href="<c:url value='/Controller/Annotation.do?paramvar=[Annotation]'/>">
					Annotation으로 컨트롤러 만들기
				</a>
			</li>
		</ul>
